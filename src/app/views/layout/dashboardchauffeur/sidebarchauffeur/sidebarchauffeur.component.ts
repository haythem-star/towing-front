...
import { MENU } from './menuchauffeur';
import { MenuChauffeurItem } from './menuchauffeurmodel';
import { Router, NavigationEnd } from '@angular/router';

@Component({
  selector: 'app-sidebarchauffeur',
  templateUrl: './sidebarchauffeur.component.html',
  styleUrls: ['./sidebarchauffeur.component.scss']
})
export class SidebarChauffeurComponent implements OnInit, AfterViewInit {

  @ViewChild('sidebarToggler') sidebarToggler: ElementRef;

  menuItems: MenuChauffeurItem[] = [];
   ...
   * @param item menuItem
   */
  hasItems(item: MenuChauffeurItem) {
