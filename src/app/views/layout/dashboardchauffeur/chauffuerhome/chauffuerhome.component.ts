...
@Component({
  selector: 'app-chauffuerhome',
  templateUrl: './chauffuerhome.component.html',
  styleUrls: ['./chauffuerhome.component.scss'],
  preserveWhitespaces: true
})
export class ChauffuerHomeComponent implements OnInit {
